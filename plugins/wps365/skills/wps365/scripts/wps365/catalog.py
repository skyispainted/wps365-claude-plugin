...
COMMANDS = (
    ...
    _command("drive", "+search", "搜索云文档", inputs=("keyword",), subcommand=("file", "search")),
    _command("drive", "+get", "获取文件详情", inputs=("file_id 或 --link-id",), subcommand=("file", "get")),
    _command("drive", "+read", "读取云文档正文", inputs=("file_id 或 --link-id", "--format?"), subcommand=("file", "read")),
    ...
    _command("base", "+list", "列出多维表记录", inputs=("file_id", "sheet_id"), subcommand=("record", "list")),
